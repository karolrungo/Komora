...
namespace Komora.Controls
{
    public partial class CalibrationControl : UserControl
    {
        ...
        public event CoefficientsButtonEventHandler DeleteCoefficientsButtonClicked;

        private string filename;
        private Utilities.CoefficientsType coefficientsType;

        public CalibrationControl(Utilities.CoefficientsType type)
        {
            InitializeComponent();
            coefficientsType = type;
        }
        ...
        private void buttonDeleteCoefficients_Click(object sender, EventArgs e)
        {
            if(onlyOneRowSelected(dataGridViewPolynomial))
            {
                if (DeleteCoefficientsButtonClicked != null)
                {
                    DeleteCoefficientsButtonClicked(this, 
